...
<head>
    ...
    <!-- Link to the loading screen CSS file -->
    <link rel="stylesheet" href="{{ asset('loading_screen/loading_screen.css') }}">
...
<body data-topbar="dark">
    ...
    {{-- loading screen js --}}
    <script src="{{ asset('loading_screen/loading_screen.js') }}"></script>
